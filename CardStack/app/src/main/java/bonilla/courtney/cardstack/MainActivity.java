...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fl.setOnClickListener (new View.OnClickListener() {
            ...
            {
                Collections.shuffle(cards);//randomize the stack

                Card card = cards.pop();


                card.changeNum(text_up_left, text_low_right);
                card.changeSuit(text_up_left, text_low_right, suit_left, suit_center, suit_right);
